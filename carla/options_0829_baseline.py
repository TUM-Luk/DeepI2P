...
class Options:
    def __init__(self):
        ...
        self.train_txt = "dataset_large_int_train/train_list/train_allscene_v50_s25_io03_vo025.txt"
        self.val_txt = "dataset_large_int_train/train_list/query_t3_int4_v50_s25_io03_vo025.txt"
        self.test_txt = "dataset_large_int_train/train_list/query_t10_int1_v50_s25_io03_vo025.txt"
        
        self.checkpoints_dir = 'checkpoints_carla'
        self.version = '0829_fine_baseline'
        self.is_debug = False
